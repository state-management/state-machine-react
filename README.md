...
Found a bug or have an idea for a new feature? Let us know by [opening an issue](https://github.com/state-management/state-machine-react/issues).

### Discuss features and approaches
Start a discussion in the [Discussions](https://github.com/state-management/state-machine-react/discussions) tab.
